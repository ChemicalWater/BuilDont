...
namespace DitzelGames.FastIK
{
    ...
    [Header("Solver Parameters")]
        ...
        void GetTarget()
        {
            if (!this.name.Contains("Ankle"))
            {
                if (InventoryScript.equippedItem.IsHammer())
                {
                    Target = TargetOG;
                }
                else
                {
                    switch (InventoryScript.equippedItem.GetItemType())
                    {
                        case ItemType.bomb:
                            Target = Targetbomb;
                            break;
